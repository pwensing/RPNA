...
% Prints a parameter summary from the outputs of the RPNA algorithm
    ...
    for i = 1:model.NB
       fprintf('===============================\n');
        ...
        for k = 1:10
           if IsIdentifiable_motor(model,N,i,k)
              fprintf('%s\n',a{k});
              x=x+1;
           end
        end 
        ...
        for k = 1:10
           if IsIdentifiable_motor(model,N,i+model.NB,k)
              fprintf('Motor %s\n',a{k});
              x=x+1;
           end
        end 
        ...
        for k = 1:10
           if IsUnidentifiable_motor(model,N,i,k)
              fprintf('%s\n',a{k});
              x=x+1;
           end
        end
        ...
        for k = 1:10
           if IsUnidentifiable_motor(model,N,i+model.NB,k)
              fprintf('Motor %s\n',a{k});
              x=x+1;
           end
        end
