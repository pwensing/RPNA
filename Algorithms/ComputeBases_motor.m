function [Null_Basis, Minimal_Basis, Perp_Basis, Perp_Basis_sym] = ComputeBases_motor(model, N, M) 
...
% N and M are given as outputs of the RPNA algorithm
    ...
    for i = 1:model.NB
        ...
        if parent > 0
            ...
            AX_motor_sym = Transform_Parameters(model.Xtree_motor_sym{i});
            ...
            Perp_Basis_sym(i_inds,:)              = [AX_sym AX_motor_sym*model.motor_constraint{i}]'*Perp_Basis_sym(parent_inds,:);
